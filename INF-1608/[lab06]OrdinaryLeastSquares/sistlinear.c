...
static void permutation(double**A, double** mtx_factors, int* perm_array, int j, int n, int indice_max){
	...
	double* aux = vetcria(n);				// we have to switch lines #indice_max and #j for each other.
	int a;
	...
	vetlibera(aux);								// after changing values, the auxiliar array has no function anymore
